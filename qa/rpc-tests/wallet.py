...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 taco, node2 has none. 
#   d) node0 sends 21 taco to node2, in two transactions (11 taco, then 10 taco).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 taco from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 taco in block rewards plus fees, but
