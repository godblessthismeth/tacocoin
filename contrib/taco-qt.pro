...
RESOURCES += src/qt/taco.qrc src/qt/taco_locale.qrc
TRANSLATIONS += src/qt/locale/taco_bg.ts \
                src/qt/locale/taco_de.ts \
                src/qt/locale/taco_en.ts \
                src/qt/locale/taco_es.ts \
                src/qt/locale/taco_fi.ts \
                src/qt/locale/taco_fr.ts \
                src/qt/locale/taco_it.ts \
                src/qt/locale/taco_ja.ts \
                src/qt/locale/taco_pl.ts \
                src/qt/locale/taco_pt.ts \
                src/qt/locale/taco_ru.ts \
                src/qt/locale/taco_sk.ts \
                src/qt/locale/taco_sv.ts \
                src/qt/locale/taco_vi.ts \
                src/qt/locale/taco_zh_CN.ts \
                src/qt/locale/taco_zh_TW.ts
