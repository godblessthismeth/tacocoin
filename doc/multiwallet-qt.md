...
Only requiring some minor changes is taco.cpp.
...
Changes to taco.cpp
----------------------
taco.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
