...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* taco features */
    { "taco",               "masternode",             &masternode,             true,      true,       false },
    { "taco",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "taco",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "taco",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "taco",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "taco",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "taco",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "taco",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "taco",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use tacod, or the -server option to taco-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> taco-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6669/\n";
}
