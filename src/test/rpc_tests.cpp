...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(write_string(ValueFromAmount(2069696969696990LL), false), "20696999.69699990");
    BOOST_CHECK_EQUAL(write_string(ValueFromAmount(2069696969696999LL), false), "20696999.69696969");
}
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20696999.6969999")), 2069696969696990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20696999.69696969")), 2069696969696999LL);
}
