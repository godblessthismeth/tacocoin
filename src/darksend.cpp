...
/* *** BEGIN DARKSEND MAGIC - taco **********
    Copyright (c) 2014-2015, taco Developers
        eduffield - evan@godblessthismeth.io
        udjinm6   - udjinm6@godblessthismeth.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat taco and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    if (!pwalletMain->SelectCoinsDark(nValueMin, nBalanceNeedsAnonymized, vCoins, nValueIn, 0, nDarksendRounds))
    {
        ...
        if (pwalletMain->SelectCoinsDark(nValueMin, 6969999*COIN, vCoins, nValueIn, -2, 0))
        {
