    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("taco Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a taco address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and taco: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About taco Core"), this);
    aboutAction->setStatusTip(tr("Show information about taco Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for taco"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your taco addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified taco addresses"));
    ...
    openAction->setStatusTip(tr("Open a taco: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the taco Core help message to get a list with possible taco command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("taco Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to taco network", "", count));
}
...
{
    QString strTitle = tr("taco Core"); // default title
