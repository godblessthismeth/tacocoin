    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("taco Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About taco Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  taco-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("taco Core is shutting down...") + "<br /><br />" +
